      ...
      const html = `
        <span class='child_status'>
          ...
          <div class='child_secrow' style='margin-left: 21px; margin-bottom: 7px; border-radius: 4px;'>
            ...
            <span class='glyphicon glyphicon-trash child-action-delete' data-action='delete-link' title='{{_('Delete Link')}}' style='cursor: pointer; font-size: 12px; color:#eee;'></span>&nbsp;&nbsp;
            <span class='glyphicon glyphicon-repeat child-action-restart' data-action='restart-link' title='{{_('Restart Link')}}' style='cursor: pointer; font-size: 12px; color:#eee;'></span>
          </div>`;
